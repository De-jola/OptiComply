...
const Solutions = () => {
  return (
    <>
      <section className="bg-orange-25 px-4 py-8 lg:py-14 lg:px-20 xl:px-28 xl:py-20 ">
        <div className="flex flex-col gap-[24px] lg:gap-[48px]">
          ...
          <div className="flex flex-wrap content-start   sm:text-center  justify-center lg:text-left gap-6 lg:gap-8 xl:gap-[48px]">
            <div className="flex flex-col gap-y-4 bg-orange-100 p-8 sm:items-center sm:rounded-[12px] lg:rounded-[20px] lg:items-start lg:w-[448px] xl:h-[282px]  xl:w-[584px]">
            ...
            <div className="flex flex-col gap-4 bg-orange-100 p-8 sm:rounded-[12px] lg:rounded-[20px] sm:items-center lg:items-start lg:w-[448px] lg:h-[288px]  xl:w-[584px]">
              <div className="bg-orange-600 w-[48px] xl:w-[64px] flex justify-center p-2 rounded-xl">
                <img src={aiIcon} />
              </div>
              <h1 className="text-[24px] lg:text-2xl xl:text-3xl font-bold text-orange-600">
            ...
            <div className="flex flex-col gap-4 bg-orange-100 p-8 sm:rounded-[12px] lg:rounded-[20px] sm:items-center lg:items-start lg:w-[448px] lg:h-[288px] xl:h-[282px] xl:w-[584px]">
              <div className="bg-orange-600 w-[48px] xl:w-[64px] flex justify-center p-2 rounded-xl">
                <img src={binoculars} />
              </div>
              <h1 className="text-[24px] lg:text-2xl xl:text-3xl font-bold text-orange-600">
            ...
            <div className="flex flex-col gap-4 bg-orange-100 p-8 sm:rounded-[12px] lg:rounded-[20px] sm:items-center lg:items-start lg:w-[448px] xl:h-[282px] xl:w-[584px]">
              <div className="bg-orange-600 w-[48px] xl:w-[64px] flex justify-center p-2 rounded-xl">
                <img src={customer} />
              </div>
              <h1 className="text-[24px] lg:text-2xl xl:text-3xl font-bold text-orange-600">
